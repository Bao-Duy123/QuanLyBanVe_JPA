...
public class LoaiVeJPAPanel extends JPanel {
    ...
    private void taiDuLieuVaoBang() {
        ...
        Future<List<LoaiVe>> future = executor.submit(() -> loaiVeRepository.findAllOrderByTenLoai());

        SwingUtilities.invokeLater(() -> {
            try {
                List<LoaiVe> danhSach = future.get();
                ...
                lblStatus.setText("Đã tải " + danhSach.size() + " loại vé");
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new LoaiVeJPAPanel());
